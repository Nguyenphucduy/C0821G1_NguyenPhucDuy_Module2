...
public class Intern extends Candidate{
    ...
    public Intern(int id, int[] birthDate, int[] phone, String firstName, String lastName, String address, String email, String majors, String university, int semester) {
